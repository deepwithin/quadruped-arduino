...
float height = -14.5;   //height of bot from ground- a negative quantity
float values[5];
float Ax=5 ,Ay=3 , X_vel_n2p=4, X_vel_p2n=8, Y_vel=16;
/* amplitude along x
 * amplitude along y
...
void horsewalk(float* values)
{
  ...
  delay(10);
  hlb_srv.write(values[2]-20);
  klb_srv.write(values[3]-50);
//#2
