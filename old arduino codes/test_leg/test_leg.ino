...
/*
  ...
  find_angles(values);  
  hlf_srv.write(180-(values[2]+60) );
  klf_srv.write( 180-(values[3]+90) );
  delay(5);
  */
  //#3
  legcontrol(values,0,0);
...
//  Serial.println(values[3]);
  delay(5);
  hrb_srv.write(180-(values[2]+60) );
  krb_srv.write( 180-(values[3]+90) );
  ...
  find_angles(values);
  delay(5);
  hrf_srv.write(values[2]+60);
  krf_srv.write(values[3]+90);
  */
