...
//--------------------------------------------------------------------------------------------------------
//#1 lb
  hlb_srv.write( (values1[2]+30 -60));  //+30 is the tilt correction for hip
  klb_srv.write(180-(values1[3]+90));  //knee angle needs to be shifted by 90 always due to our setup
//#2 lf
  hlf_srv.write(180-(values2[2]+30 -60));
  klf_srv.write( (values2[3]+90));
//#3 rb
  hrb_srv.write(180-(values3[2]+30 -60));
  krb_srv.write( (values3[3]+90) );
//#4 rf
  hrf_srv.write( (values4[2]+30 -60));
